...
ROBOT_XML_DICT = {
    ...
    "gp2_v2": ASSET_ROOT / "gp2_v2" / "mjcf" / "gp02_v3.xml",
    ...
    "agibot_x2": ASSET_ROOT / "agibot_x2" / "x2_ultra.xml",
}
...
IK_CONFIG_DICT = {
    ...
    "smplx":{
        ...
        "gp2_v2": IK_CONFIG_ROOT / "smplx_to_gp2_v2.json",
        ...
        "agibot_x2": IK_CONFIG_ROOT / "smplx_to_agibot_x2.json",
    },
    "bvh_lafan1":{
        ...
        "gp2_v2": IK_CONFIG_ROOT / "bvh_lafan1_to_gp2_v2.json",
        "pal_talos": IK_CONFIG_ROOT / "bvh_to_talos.json",
        "agibot_x2": IK_CONFIG_ROOT / "bvh_lafan1_to_x2.json",
    },
    "bvh_nokov":{
